...
def get_header():
    ...
    dropdown = dbc.DropdownMenu(color="success",direction="left", right=False,
        children=[
            dbc.DropdownMenuItem("Regions", id = "regionmenu", href = '/SnowDashboard/regions'),
            dbc.DropdownMenuItem("Key Applications", id = "keyappsmenu", href = '/SnowDashboard/keyapps'),
            dbc.DropdownMenuItem("Legacy Report", href = '/SnowDashboard/legacy'),
            dbc.DropdownMenuItem("SLA's", disabled=True, href = '/SnowDashboard/sla'),
            dbc.DropdownMenuItem("Compare", href = '/SnowDashboard/compare'),
            dbc.DropdownMenuItem(divider=True),
            dbc.DropdownMenuItem("Themes", disabled=True, href = '/SnowDashboard/themes'),
            ],
        nav=True,
        in_navbar=True,
        label="Menu",
